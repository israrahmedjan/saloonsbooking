      ...
      {cart.length > 0 && (
        <div className="mt-6 border-secondary/20 border-t pt-5">
          <div className="mb-5 flex items-center justify-between text-lg font-semibold">
            ...
            <button type="submit" className="flex w-full items-center cursor-pointer justify-center gap-2 rounded-2xl bg-secondary hover:bg-primary/80 px-5 py-3 font-medium text-white transition hover:opacity-90">Pay Now</button>
          {/* <button className="flex w-full items-center cursor-pointer justify-center gap-2 rounded-2xl bg-secondary hover:bg-primary/80 px-5 py-3 font-medium text-white transition hover:opacity-90" 
